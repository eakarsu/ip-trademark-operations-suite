...
PORT="${PORT:-5600}"
DB_NAME="${PGDATABASE:-ip_trademark_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      IP Trademark Operations Suite"
echo "======================================="
echo
...
echo "Starting ip trademark operations suite frontend on http://localhost:$PORT"
echo "Login: admin@ip-trademark-operations.local / admin123"
