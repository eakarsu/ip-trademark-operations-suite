...
const featureSeeds = [
  ...
  ["prior-art-search","Prior Art Search","Prior Art Search review queue","Patent Research Filing","Review source context and assign owner"],
  ["claims-chart","Claims Chart","Claims Chart review queue","Patent Research Filing","Confirm next action and update evidence"],
  ["patent-filing-packet","Patent Filing Packet","Patent Filing Packet review queue","Patent Research Filing","Confirm next action and update evidence"],
  ["trademark-watchlist","Trademark Watchlist","Trademark Watchlist review queue","Trademark Brand Protection","Review source context and assign owner"],
  ["brand-infringement-review","Brand Infringement Review","Brand Infringement Review review queue","Trademark Brand Protection","Confirm next action and update evidence"],
  ["opposition-deadlines","Opposition Deadlines","Opposition Deadlines review queue","Trademark Brand Protection","Confirm next action and update evidence"],
