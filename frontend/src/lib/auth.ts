export const AUTH_COOKIE = 'ip_trademark_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@ip-trademark-operations.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@ip-trademark-operations.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@ip-trademark-operations.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
