...
const entitySeeds = [
  ...
  ["prior-art-search","Prior Art Search Records","Prior Art Search operating queue","Open","Prior Art Search follow-up list","Patent Research Filing","$0"],
  ["claims-chart","Claims Chart Records","Claims Chart operating queue","Review","Claims Chart follow-up list","Patent Research Filing","$0"],
  ["patent-filing-packet","Patent Filing Packet Records","Patent Filing Packet operating queue","Review","Patent Filing Packet follow-up list","Patent Research Filing","$0"],
  ["trademark-watchlist","Trademark Watchlist Records","Trademark Watchlist operating queue","Open","Trademark Watchlist follow-up list","Trademark Brand Protection","$0"],
  ["brand-infringement-review","Brand Infringement Review Records","Brand Infringement Review operating queue","Review","Brand Infringement Review follow-up list","Trademark Brand Protection","$0"],
  ["opposition-deadlines","Opposition Deadlines Records","Opposition Deadlines operating queue","Review","Opposition Deadlines follow-up list","Trademark Brand Protection","$0"],
