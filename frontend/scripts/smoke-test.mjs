const baseUrl = process.env.SMOKE_BASE_URL || 'http://127.0.0.1:5600';
...
const adminCookie = await login('admin@ip-trademark-operations.local', 'admin123');
const managerCookie = await login('manager@ip-trademark-operations.local', 'manager123');
const analystCookie = await login('analyst@ip-trademark-operations.local', 'analyst123');
